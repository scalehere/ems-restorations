...
export const navLinks: NavLink[] = [
  { label: "Home", href: "#" },
  {
    ...
    children: [
      ...
      { label: "Fire & Smoke Damage Restoration", href: "#" },
      { label: "Mold Remediation", href: "#" },
      { label: "Biohazard Cleanup", href: "#" },
      { label: "Home Remodeling & Construction", href: "#" },
    ],
  },
  {
    label: "About Us",
...
export const footerColumns = [
  ...
  },
  {
    title: "Services",
    items: [
      { type: "link" as const, label: "Water Damage Restoration", href: "#" },
      { type: "link" as const, label: "Fire & Smoke Restoration", href: "#" },
      { type: "link" as const, label: "Mold Remediation", href: "#" },
      { type: "link" as const, label: "Biohazard Cleanup", href: "#" },
      { type: "link" as const, label: "Home Remodeling", href: "#" },
    ],
  },
  {
    title: "Company",
    items: [
      { type: "link" as const, label: "About Us", href: "#" },
      { type: "link" as const, label: "Reviews", href: "#" },
      { type: "link" as const, label: "Gallery", href: "#" },
