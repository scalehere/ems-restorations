    ...
    <section className="bg-white py-16 lg:py-20">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mt-5 text-[18px] leading-[1.6]">
          Call EMS Restoration now for a free estimate. We&rsquo;ll document the damage, work directly with your insurance provider, and be there today if it&rsquo;s an emergency.
        </p>
